...
(function () {
   'use strict'
	...
	// jQuery(window).scroll(function(){
		// if( jQuery(window).scrollTop() > 480 && jQuery(window).width() > 768 )
		// {
			// jQuery('.rst-banner-content,.rst-header-banner').css('margin-top',jQuery('.rst-header-menu').height() + 'px');
			// jQuery('.rst-header-menu').addClass('active');
			
		// } else
		// {
			// jQuery('.rst-header-menu').removeClass('active');
			// jQuery('.rst-banner-content,.rst-header-banner').css('margin-top',0 + 'px');
		// }
	// });
